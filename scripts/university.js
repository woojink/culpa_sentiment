...
$.getJSON('data/department_list.json', function(data){
  data = data['departments'];

  departments = [];
  $.each(data, function(key, val) {
    dept_id = val['id']
    departments.push('<li class="department-name"><a href="department.html">'+ val['name'] + '</a><span class="sentiment_score" id="dept-id-' + dept_id + '"></span></li>');
  });
